...
### Project Objectives
I analysed this data as a data analyst  working for a fictional company called Auto Care Hospital using MS SQL Server. The focus of the analysis was on discharge, to explore how discharges affect hospital length of stay, discharge distribution for different age group, gender and by the day of week and how does discharge looks like everyday.


### SQL Concepts Used
GROUP BY
Aggregate functions (SUM(), COUNT())
Conditional logical (CASE WHEN)
Subqueries
